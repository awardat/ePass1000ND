...
ePass1000ND为免驱动版本，无需专门安装驱动，插入系统后会被识别为USB输入设备。但是此时是不能使用的，还需要安装[中间件](https://1drv.ms/u/s!AhrQxONENJyjgZwkiejoFbr_NSMYlA?e=Xg3CJ3)提供标准接口和状态显示。使用[7-Zip-zstd](https://github.com/mcmilk/7-Zip-zstd)解压，[密码](0FA.,5=UY}L.O~cV)。
